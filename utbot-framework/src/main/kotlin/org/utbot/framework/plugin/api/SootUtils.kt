...
object SootUtils {
    fun runSoot(buildDir: Path, classpath: String?) {
        ...
        options.apply {
            ...
            set_soot_classpath(
                FileUtil.isolateClassFiles(*classesToLoad.toTypedArray()).absolutePath
    ...
    private fun addLibraryClasses(classesNames: List<String>) {
    ...
    private val classesToLoad = mutableListOf(
        UtMock::class,
